...
const checkAudio = new Audio("/HappyNewYear/assets/audio/check.mp3");
const flagAudio = new Audio("/HappyNewYear/assets/audio/flag-2.mp3");
...
const fireworkAudio = new Audio("/HappyNewYear/assets/audio/firework.mp3");
const fireworkStartAudio = new Audio("/HappyNewYear/assets/audio/firework-start.mp3");
